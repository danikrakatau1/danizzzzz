...
const checks=[
 ...
 ['V261 only intentional non-passive move',count(v261,/touchmove[\s\S]{0,260}passive:false/g)===1],
 ...
 ['fee one submit transaction path',count(fee,/addEventListener\(['\"]submit['\"]/g)===1],
 ['profit one submit transaction path',count(profit,/addEventListener\(['\"]submit['\"]/g)===1],
